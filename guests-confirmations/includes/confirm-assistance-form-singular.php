...
<p class='info'><b>¡Bienvenid@ <?php echo $registros[0][nombre];?>! Cuentas con un pase adicional. Favor de indicar su asistencia así como el de tu pase adicional ¡Gracias!</b><p>
...
<?php elseif ($registros[0][asistencia] == 'si' && $pase_adicional == 'si') : ?>

<p class='exito'><b>¡Bienvenid@ <?php echo $registros[0][nombre]?>. Ya has confirmado asistencia de <?php echo $registros[0][pases_confirmados]?> pases el día <?php echo $fecha[0];?> a las <?php echo $fecha[1];?> hrs., y asignando el correo: <?php echo $registros[0][correo];?>.</b></p>
...
<p class='exito'><b>¡Bienvenid@ <?php echo $registros[0][nombre]?>. Ya has confirmado asistencia el día <?php echo $fecha[0];?> a las <?php echo $fecha[1];?> hrs., y asignando el correo: <?php echo $registros[0][correo];?>.</b></p>
...
<p class='exito'><b>¡Bienvenid@ <?php echo $registros[0][nombre] ?>!. Has indicado que no asistirás al evento. Por cuestiones de actualización de espacios e invitados no se puede modificar esta respuesta. Si la confirmación ha sido errónea, por favor diríjete a la sección de contaco y comunícate con los novios para que se haga la modificación. Gracias. </b></p>
