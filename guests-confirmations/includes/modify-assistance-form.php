...
<p class='info'><b>¡Bienvenidos familia <?php echo $registros[0][familia];?>! Cuentan con <?php echo $registros[0][pases];?> pases asignados y un pase adicional. Han escogido hacer una modificación a su confirmación. Favor de confirmar asistencia, así como el número de pases que utilizarán ¡Gracias!</b><p>
...
<p class='info'><b>¡Bienvenidos familia <?php echo $registros[0][familia];?>! Cuentan con <?php echo $registros[0][pases];?> pases asignados y <?php echo $pases_adicionales?> pases adicionales. Han escogido hacer una modificación a su confirmación. Favor de confirmar asistencia, así como el número de pases que utilizarán ¡Gracias!</b><p>
<p><b><small>Por favor, tengan en cosideración que al enviar como respuesta un "No" sus lugares serán asignados a otras personas.</small></b></p>

<?php else : ?>
<p class='info'><b>¡Bienvenidos familia <?php echo $registros[0][familia];?>! Cuentan con <?php echo $registros[0][pases];?> pases asignados. Han escogido hacer una modificación a su confirmación. Favor de confirmar asistencia, así como el número de pases que utilizarán ¡Gracias!</b><p>
<p><b><small>Por favor, tengan en cosideración que al enviar como respuesta un "No" sus lugares serán asignados a otras personas.</small></b></p>
...
<p class='exito'><b>¡Bienvenidos familia <?php echo $registros[0][familia] ?>!. Ya han confirmado asistencia de <?php echo $registros[0][pases]?> pases el día <?php echo $fecha[0];?> a las <?php echo $fecha[1];?> hrs., y asignando el correo: <?php echo $registros[0][correo];?>.</b></p>
